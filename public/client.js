...
class CreditsTextOverlay extends FullSize {
    constructor(_screen) {
        ...
        this.render = function () {
            [
                'Haruki Andrews|programmer|grey',
                'Haruki Andrews|graphics designer|purple',
                'Haruki Andrews|debugger|blue',
            ].forEach((line, index) => {
...
window.addEventListener("load", function () {
    ...
    addEntity(new TitleButton(a.width / 2 - 200, 400, 'Connect', 'cmd', () => socket.emit('join'), 3));
    addEntity(new TitleButton((a.width / 2) - 200, 440, 'Creator', 'blame', () => screen = 5, 3));
    addEntity(new TitleButton(a.width / 2 - 200, 480, 'Internal Documentation', 'log', () => screen = 6, 3));
